...
p <- ggplot(dat_homelessness, aes(x = date, y = n)) +
...
# Convert the ggplot object to plotly and position the legend
ggplotly(p) %>%
  plotly::layout(legend = list(
    x = 0.3,
    y = -0.25, # Adjust this value to control vertical position
    xanchor = 'left',
    yanchor = 'bottom',
    orientation = 'h'
  ))
